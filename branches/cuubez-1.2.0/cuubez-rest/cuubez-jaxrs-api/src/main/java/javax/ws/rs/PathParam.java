 ...
 * is disabled using the {@link javax.ws.rs.Encoded} annotation.
 ...
 * annotated with a {@link javax.ws.rs.Path} containing the same URI template parameter, use
 * of {@code PathParam} on a subresource method parameter will bind the value 
 * matching URI template parameter in the method's {@link javax.ws.rs.Path} annotation.</p>
 * 
