 ...
 * by a [key, multi-value] store represented as a {@link java.util.Map Map&lt;K, List&lt;V&gt;&gt;}.
 *
...
public abstract class AbstractMultivaluedMap<K, V> implements MultivaluedMap<K, V> {
     ...
     * implementation.
     *
     * @param store the backing {@link java.util.Map} to be used as a [key, multi-value]
     ...
     * empty.
     * <p />
     * If there is no entry for the key in the map, a new empty {@link java.util.List}
