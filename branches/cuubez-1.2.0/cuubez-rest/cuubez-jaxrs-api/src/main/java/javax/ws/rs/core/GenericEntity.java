 ...
 * {@link javax.ws.rs.core.Response} instance that contains, e.g., an entity of type
 * {@code List<String>} appears to contain a raw {@code List<?>} at runtime.
 * When the generic type is required to select a suitable
 * {@link javax.ws.rs.ext.MessageBodyWriter}, this class may be used to wrap the entity and
 ...
 * {@link javax.ws.rs.core.Response} containing an entity of type {@code List<String>} whose
