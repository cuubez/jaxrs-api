 ...
 * by overriding the protected {@link #addNull(java.util.List) addNull(...)} and
 * {@link #addFirstNull(java.util.List) addFirstNull(...)} methods.
 * <p />
...
public class MultivaluedHashMap<K, V> extends AbstractMultivaluedMap<K, V> implements Serializable {
     ...
     * specified {@link MultivaluedMap }. The {@link java.util.List} instances holding
    ...
    /**
     * Constructs a new multivalued hash map with the same mappings as the
     * specified single-valued {@link java.util.Map }.
     *
