...
public interface Request {
     ...
     * @throws IllegalArgumentException if variants is empty or null
     ...
     * @throws IllegalArgumentException if eTag is null
     * @throws IllegalStateException if called outside the scope of a request
     */
     ...
     * @throws IllegalArgumentException if lastModified is null
     * @throws IllegalStateException if called outside the scope of a request
     */
     ...
     * the appropriate status if the preconditions are not met.  A returned
     * ResponseBuilder will include an ETag header set with the value of eTag.
     * @throws IllegalArgumentException if lastModified or eTag is null
     * @throws IllegalStateException if called outside the scope of a request
     */
