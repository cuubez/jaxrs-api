...
public class Variant {
    ...
    /**
     * Create a {@link javax.ws.rs.core.Variant.VariantListBuilder} initialized with a set of supported
     * media types.
     ...
     * @throws IllegalArgumentException if mediaTypes is null or
     ...
     * @return the initailized builder
     * @throws IllegalArgumentException if languages is null or
     * contains no elements.
     */
     ...
     * @return the initailized builder
     * @throws IllegalArgumentException if encodings is null or
     * contains no elements.
     */
