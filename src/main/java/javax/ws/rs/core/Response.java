...
public abstract class Response {
     ...
     * relative to the request URI (see {@link javax.ws.rs.core.UriInfo#getRequestUri}).
     * @return a new ResponseBuilder
     ...
     * {@link javax.ws.rs.core.UriInfo#getBaseUri}).
     * @return a new ResponseBuilder
     * @throws IllegalArgumentException if location is null
     */
    ...
    public static abstract class ResponseBuilder {
         ...
         * supplied it will be converted into an absolute URI by resolving it
         * relative to the base URI of the application (see 
         * {@link javax.ws.rs.core.UriInfo#getBaseUri}). If null any
